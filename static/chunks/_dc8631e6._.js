...
"[project]/src/ai/flows/data:e2db9a [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$e2db9a__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/ai/flows/data:e2db9a [app-client] (ecmascript) <text/javascript>");
...
function SearchComponent() {
    ...
    const [displayedQuery, setDisplayedQuery] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialQuery);
    ...
    const allProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SearchComponent.useMemo[allProducts]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$products$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getProducts"])()
    }["SearchComponent.useMemo[allProducts]"], []);
    const trendingProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SearchComponent.useMemo[trendingProducts]": ()=>trendingProductIds.map({
                "SearchComponent.useMemo[trendingProducts]": (id)=>allProducts.find({
                        "SearchComponent.useMemo[trendingProducts]": (p)=>p.id === id
                    }["SearchComponent.useMemo[trendingProducts]"])
            }["SearchComponent.useMemo[trendingProducts]"]).filter({
                "SearchComponent.useMemo[trendingProducts]": (p)=>p !== undefined
            }["SearchComponent.useMemo[trendingProducts]"])
    }["SearchComponent.useMemo[trendingProducts]"], [
        allProducts
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SearchComponent.useEffect": ()=>{
            const performSearch = {
                "SearchComponent.useEffect.performSearch": async ()=>{
                    if (!displayedQuery) {
                        setProducts([]);
                        return;
                    }
                    ...
                    const directMatches = allProducts.filter({
                        "SearchComponent.useEffect.performSearch.directMatches": (p)=>p.name.toLowerCase().includes(lowercasedQuery) || p.description.toLowerCase().includes(lowercasedQuery) || p.scentFamily.toLowerCase().includes(lowercasedQuery)
                    }["SearchComponent.useEffect.performSearch.directMatches"]);
                    ...
                    try {
                        const productNames = allProducts.map({
                            "SearchComponent.useEffect.performSearch.productNames": (p)=>p.name
                        }["SearchComponent.useEffect.performSearch.productNames"]);
                        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$e2db9a__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["searchProducts"])({
                            query: displayedQuery,
                            productNames
                        });
                        const aiRecommendedProducts = result.recommendations.map({
                            "SearchComponent.useEffect.performSearch.aiRecommendedProducts": (name)=>allProducts.find({
                                    "SearchComponent.useEffect.performSearch.aiRecommendedProducts": (p)=>p.name === name
                                }["SearchComponent.useEffect.performSearch.aiRecommendedProducts"])
                        }["SearchComponent.useEffect.performSearch.aiRecommendedProducts"]).filter({
                            "SearchComponent.useEffect.performSearch.aiRecommendedProducts": (p)=>p !== undefined
                        }["SearchComponent.useEffect.performSearch.aiRecommendedProducts"]);
            ...
            }["SearchComponent.useEffect.performSearch"];
            performSearch();
        }
    }["SearchComponent.useEffect"], [
        displayedQuery,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                }, void 0, true) : displayedQuery ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "flex flex-col items-center justify-center text-center py-20",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
...
_s(SearchComponent, "b9P627Dvrt4alfFbH501X3HQ7vo=", false, function() {
    return [
...
function SearchPage() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Suspense"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(SearchComponent, {}, void 0, false, {
            fileName: "[project]/app/search/page.tsx",
            lineNumber: 159,
            columnNumber: 13
        }, this)
...
//# sourceMappingURL=_dc8631e6._.js.map